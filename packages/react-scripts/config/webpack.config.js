...
module.exports = function(webpackEnv, opts = {}) {
  const isWatcher = opts.watch === true;
  ...
  const publicPath =
    isEnvProduction || isWatcher ? paths.servedPath : isEnvDevelopment && '/';
  ...
  return {
    ...
    output: {
      // The build folder.
      path: isEnvProduction || isWatcher ? paths.appBuild : undefined,
      ...
      filename: isEnvProduction
        ...
        : isEnvDevelopment && 'static/js/[name].[chunkhash:8].js',
